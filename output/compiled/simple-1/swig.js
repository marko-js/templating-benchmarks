...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache06754699730470388 = { loop: _ctx.loop, color: _ctx.color, __k: _ctx.__k };
...
_output += "</li>\n            ";
  ...
  _ctx.loop = _ctx__loopcache06754699730470388.loop;
  _ctx.color = _ctx__loopcache06754699730470388.color;
  _ctx.__k = _ctx__loopcache06754699730470388.__k;
  _ctx__loopcache06754699730470388 = undefined;
})();
_output += "\n        </ul>\n        ";
} else {
_output += "\n        <div>\n            No colors!\n        </div>\n        ";
