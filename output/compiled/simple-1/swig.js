...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache012990112253464758 = { loop: _ctx.loop, color: _ctx.color, __k: _ctx.__k };
...
_output += "</li>\n        ";
  ...
  _ctx.loop = _ctx__loopcache012990112253464758.loop;
  _ctx.color = _ctx__loopcache012990112253464758.color;
  _ctx.__k = _ctx__loopcache012990112253464758.__k;
  _ctx__loopcache012990112253464758 = undefined;
})();
_output += "\n    </ul>\n    ";
} else {
_output += "\n    <div>\n        No colors!\n    </div>\n    ";
