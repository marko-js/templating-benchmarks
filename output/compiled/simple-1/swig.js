...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache09354692024644464 = { loop: _ctx.loop, color: _ctx.color, __k: _ctx.__k };
...
_output += "</li>\n        ";
  ...
  _ctx.loop = _ctx__loopcache09354692024644464.loop;
  _ctx.color = _ctx__loopcache09354692024644464.color;
  _ctx.__k = _ctx__loopcache09354692024644464.__k;
  _ctx__loopcache09354692024644464 = undefined;
})();
_output += "\n    </ul>\n    ";
} else {
_output += "\n    <div>\n        No colors!\n    </div>\n    ";
